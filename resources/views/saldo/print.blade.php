...
<body>
    ...
    <div class="header">
      <div class="header-content">
        ...
        <div class="title-section">
          <div class="title">VOUCHER KAS MASUK</div>
    ...
    <div class="voucher-details">
      ...
      <table>
        <tr>
          ...
          <td>{{ $transaction->kontak->nama ?? 'Tidak ada kontak' }}</td>
        </tr>
        <tr>
          <td>Banyaknya Uang</td>
          <td>Rp. {{ number_format($transaction->saldo_kas, 2, ',', '.') }}</td>
        </tr>              
         <tr>
          <td>Terbilang</td>
        ...
        foreach($transaction->saldo_items as $item) {
            if ($item->category) {
    ...
    @endphp
        ...
        <tr>
          <td>Sumber Dana</td>
          <td>{{ $kategoriUnik ?: 'Kategori tidak tersedia' }}</td>
        </tr>
      </table>
